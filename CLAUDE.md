...
- Retitle/reorg note: a categories-normalization into a small consistent taxonomy (Segment Trees, Dynamic Programming, Combinatorics, Data Structures, Hashing, Number Theory, Trees & Graphs) was proposed to make the category chips a clean topical index — apply once he confirms.
